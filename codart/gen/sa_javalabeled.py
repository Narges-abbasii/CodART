...
from .JavaParserLabeled import JavaParserLabeled as JavaLabeledParser
from .JavaLexer import JavaLexer as JavaLabeledLexer
...
def _cpp_parse(stream:InputStream, entry_rule_name:str, sa_err_listener:SA_ErrorListener=None) -> ParseTree:
    ...
    return sa_javalabeled_cpp_parser.do_parse(JavaLabeledParser, stream, entry_rule_name, sa_err_listener)
...
def _py_parse(stream:InputStream, entry_rule_name:str, sa_err_listener:SA_ErrorListener=None) -> ParseTree:
    ...
    # Parse
    parser = JavaLabeledParser(token_stream)
    if sa_err_listener is not None:
